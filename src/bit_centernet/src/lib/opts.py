...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', default='KPS',
                             help='ctdet | ddd | multi_pose | exdet| KPS')
    self.parser.add_argument('--dataset', default='L_Shelf_HP',
    ...
    # dataset
    self.parser.add_argument('--not_rand_crop', action='store_true', default=True,
  ...
  def parse(self, args=''):
    ...
    opt.pad = 20 if 'hourglass' in opt.arch else 31
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [1280, 2240], 'num_classes': 1,
      ...
      'ddd': {'default_resolution': [384, 1280], 'num_classes': 3, 
                ...
                'dataset': 'kitti'},
       'KPS': {'default_resolution': [1280, 2240], 'num_classes': 1,
                  'mean': [0.32429235, 0.32851489, 0.33174885], 'std': [0.20327683, 0.21368938, 0.20512214],
                  'dataset': 'L_Shelf_HP'},
    }
    # class Struct:
