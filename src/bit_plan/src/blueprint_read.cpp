...
BrickPlan::BrickPlan()
{
	...
	//用来测试的墙体
	vector< vector<int> > fir_tempt{ vector<int>{3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3},
								   vector<int>{6,6,6, 6,6,6, 6,6,6, 6,6,6, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3},
								   vector<int>{3,3,3, 3,3,3, 3,3,3, 3,3,3, 6,6,6, 6,6,6, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3},
								   vector<int>{3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 6,6,6, 6,6,6, 6,6,6, 6,6,6, 3,3,3, 3,3,3}
	};
	vector< vector<int> > sec_tempt{ vector<int>{3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3},
								   vector<int>{6,6,6, 6,6,6, 6,6,6, 6,6,6, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3},
							       vector<int>{3,3,3, 3,3,3, 3,3,3, 3,3,3, 6,6,6, 6,6,6, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3},
							       vector<int>{3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 3,3,3, 6,6,6, 6,6,6, 6,6,6, 6,6,6, 3,3,3, 3,3,3}
	};
