...
//回调函数
void callback(const sensor_msgs::Image::ConstPtr& LeftImage, const sensor_msgs::Image::ConstPtr& RightImage, const sensor_msgs::Image::ConstPtr& MERImage) 
{
...
int main(int argc, char *argv[])
{
  ...
  message_filters::Subscriber<sensor_msgs::Image> subleft(nh,"/zed/zed_node/left/image_rect_color",1); ///zed/zed_node/left/image_rect_color  Image1
  message_filters::Subscriber<sensor_msgs::Image> subRight(nh,"/zed/zed_node/right/image_rect_color",1); ////zed/zed_node/right/image_rect_color
  message_filters::Subscriber<sensor_msgs::Image> MerImage(nh,"Image1",1); 

  message_filters::TimeSynchronizer<sensor_msgs::Image, sensor_msgs::Image, sensor_msgs::Image> sync(subleft, subRight, MerImage,5);
