...
//砖块标志位姿估计 主程序
void pose_estimation(HObject ho_ImageL)
{
  // Local iconic variables
  ...
  HTuple  hv_Seconds_3, hv_Seconds_4;
  ...
  ReadCamPar("/home/srt/test_ws/src/bit_vision/model/MER_calib.dat", &hv_CamParOriginal);
  ...
  Threshold(ho_ImageRectifiedAdaptive, &ho_Regions, 136, 218);
  ...
  try
  {
    ...
    ROS_INFO_STREAM("first Method data:"<<hv_X.D()<<","<<hv_Y.D()<","<<hv_Z.D());
    data_flag = true;
  ...
  catch (HException &HDevExpDefaultException)
  {
    ...
    try
    {
      ...
      hv_Y = ((const HTuple&)hv_PoseL)[1];
      hv_Z = ((const HTuple&)hv_PoseL)[2];
      ROS_INFO_STREAM("second Method data:"<<hv_X.D()<<","<<hv_Y.D()<","<<hv_Z.D());
      data_flag = true;
...
int main(int argc, char *argv[])
{
  ...
  // 服务-计算砖堆位置
  ros::ServiceServer service = nh.advertiseService("GetPrecisePositonData",GetPositonData);
